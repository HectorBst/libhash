...
static void sha224_compress(word_t res[BLOCK_SIZE], word_t state[8]) {
...
void sha224(const uint8_t data[], const size_t size, uint8_t hash[SHA224_HASH_SIZE]) {
	word_t datalength = 0;
...
void sha224_hash_to_str(const uint8_t hash[SHA224_HASH_SIZE], char dest[SHA224_STRING_HASH_SIZE]) {
	int i;
