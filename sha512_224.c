...
void sha512_224(const uint8_t data[], const size_t size, uint8_t hash[SHA512_224_HASH_SIZE]) {
	word_t datalength = 0;
...
void sha512_224_hash_to_str(const uint8_t hash[SHA512_224_HASH_SIZE], char dest[SHA512_224_STRING_HASH_SIZE]) {
	int i;
