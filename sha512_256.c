...
static void sha512_256_compress(word_t res[BLOCK_SIZE], word_t state[8]) {
...
void sha512_256(const uint8_t data[], const size_t size, uint8_t hash[SHA512_256_HASH_SIZE]) {
	word_t datalength = 0;
...
void sha512_256_hash_to_str(const uint8_t hash[SHA512_256_HASH_SIZE], char dest[SHA512_256_STRING_HASH_SIZE]) {
	int i;
